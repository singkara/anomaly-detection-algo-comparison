...
for i in range(0,L):
    ...
    for j in range(0,trials):
        ...
        bag_neigh = 1
        clf_spDTM = BaggingRegressor(base_estimator=DTM(n_neighbors=bag_neigh, contamination=0.1), n_estimators=1,
                                     max_samples=max_samples, bootstrap=False, random_state=rng)
